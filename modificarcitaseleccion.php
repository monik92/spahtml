...
<html lang="es">
  <head>
    ...
    <title>Buscar Cita a Modificar</title>
...
<div id="wrap">  
  <div class="text-center">
    ...
    <div class="container text-center" >
      <h3 class="text-center">Buscar Cita a Modificar</h3>
      </br>
      ...
      echo '<h3>Resultados de la busqueda</h3>';
                 ...
                 while ($row = $stmt->fetch(PDO::FETCH_ASSOC))
                    {     
                      ...
                      echo'<form class="form-horizontal" role="form" action="modificarcita.php" method="get">';
                      echo'<div class="form-group">';  
                       
                       echo'<button id="nyx" class="btn btn-default colorboton" type="submit">'.$row['cita'].' '.$row['dia'].' '.$row['hora'].'</button>';
